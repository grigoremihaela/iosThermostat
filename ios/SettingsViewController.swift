...
class SettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func logoutAccount(sender:UIButton){
        ...
        let log = UIAlertAction(title: "Logout", style: UIAlertActionStyle.Destructive) { (_) -> Void in
            ...
            //let request = NSMutableURLRequest(URL: NSURL(string: "http://localhost:1337/logout")!,
            let request = NSMutableURLRequest(URL: NSURL(string: "http://thermostat-v1.herokuapp.com/logout")!,
